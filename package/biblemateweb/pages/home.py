...
from biblemateweb import config, BIBLEMATEWEB_APP_DIR, getBibleVersionList, get_translation
...
from biblemateweb.fx.bible_selection_dialog import BibleSelectionDialog

from biblemateweb.js.bible import BIBLE_JS
from biblemateweb.js.original import get_original_js
...
from biblemateweb.pages.bibles.bible_translation import bible_translation

from biblemateweb.pages.tools.xrefs import xrefs
from biblemateweb.pages.tools.treasury import treasury
from biblemateweb.pages.tools.audio import bibles_audio
from biblemateweb.pages.tools.podcast import bibles_podcast
from biblemateweb.pages.tools.commentary import bible_commentary
from biblemateweb.pages.tools.chronology import bible_chronology
from biblemateweb.pages.tools.timelines import bible_timelines
from biblemateweb.pages.tools.indexes import resource_indexes
from biblemateweb.pages.tools.chapter_indexes import chapter_indexes
from biblemateweb.pages.tools.promises import bible_promises_menu
from biblemateweb.pages.tools.parallels import bible_parallels_menu
from biblemateweb.pages.tools.morphology import word_morphology
from biblemateweb.pages.tools.notepad import notepad
from biblemateweb.pages.tools.notes import notes
from biblemateweb.pages.tools.summary import chapter_summary
from biblemateweb.pages.tools.analysis import book_analysis

from biblemateweb.pages.search.bible_verses import search_bible_verses
from biblemateweb.pages.search.bible_promises import search_bible_promises
from biblemateweb.pages.search.bible_parallels import search_bible_parallels
from biblemateweb.pages.search.bible_topics import search_bible_topics
from biblemateweb.pages.search.bible_locations import search_bible_locations
from biblemateweb.pages.search.bible_characters import search_bible_characters
from biblemateweb.pages.search.bible_names import search_bible_names
from biblemateweb.pages.search.dictionaries import search_bible_dictionaries
from biblemateweb.pages.search.encyclopedias import search_bible_encyclopedias
from biblemateweb.pages.search.lexicons import search_bible_lexicons
from biblemateweb.pages.search.bible_maps import search_bible_maps
from biblemateweb.pages.search.bible_relationships import search_bible_relationships

from biblemateweb.pages.teachings.parousia import parousia
from biblemateweb.pages.teachings.parousia_zh import parousia_zh
...
class BibleMateWeb:
    ...
    def open_chapter_context_menu(self, db, b, c, v, note=False):
        ...
        with ui.context_menu() as menu:
            ...
            ui.menu_item(f'🔊 {get_translation("Bible Audio")}', on_click=self.open_sync_tool)
            ui.separator()
    ...
    def open_sync_tool(self, tool='Audio'):
        app.storage.user['tool_book_text'] = self.get_area_1_bible_text()
        self.load_area_2_content(title=tool, sync=True)
                    ...
                    with ui.button(on_click=lambda: ui.timer(0, show_url_popup, once=True)).props('flat text-color=white').classes('gt-xs'):
                        with ui.row().classes('items-center no-wrap'):
                            ...
                            with ui.avatar(size='32px'):
                                with ui.image(app.storage.user["avatar"] if app.storage.user["avatar"] else os.path.expanduser(config.avatar) if config.avatar else os.path.join(BIBLEMATEWEB_APP_DIR, 'eliranwong.jpg')) as image:
                ...
                with ui.row().classes('items-center no-wrap'):
                    ...
                    with ui.button(icon='build').props('flat color=white round').tooltip(get_translation("Tools")):
                        with ui.menu():
                            ...
                            ui.menu_item(get_translation("Bible Audio"), on_click=self.open_sync_tool)
                            ui.separator()
