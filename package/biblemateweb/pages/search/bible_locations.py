from biblemateweb import BIBLEMATEWEB_DATA, load_vectors_from_db, get_translation
...
def fetch_bible_locations_entry(path):
    db = os.path.join(BIBLEMATEWEB_DATA, "data", "exlb3.data")
    ...
    vdb = os.path.join(BIBLEMATEWEB_DATA, "data", "exlb3.data")
