...
bibles_dir = os.path.join(BIBLEMATEWEB_DATA, "bibles")
if os.path.isdir(bibles_dir):
    ...
    config.bibles = {}
bibles_dir_custom = os.path.join(BIBLEMATEWEB_DATA_CUSTOM, "bibles")
...
commentaries_dir = os.path.join(BIBLEMATEWEB_DATA, "commentaries")
if os.path.isdir(commentaries_dir):
    ...
    config.commentaries = {}
commentaries_dir_custom = os.path.join(BIBLEMATEWEB_DATA_CUSTOM, "commentaries")
...
# lexicons resources
lexicons_dir = os.path.join(BIBLEMATEWEB_DATA, "lexicons")
if os.path.isdir(lexicons_dir):
    ...
    config.lexicons = {}
lexicons_dir_custom = os.path.join(BIBLEMATEWEB_DATA_CUSTOM, "lexicons")
...
# fonts
app.add_static_files('/fonts', os.path.join(BIBLEMATEWEB_APP_DIR, "fonts"))

# images
app.add_static_files('/timelines', os.path.join(BIBLEMATEWEB_DATA, "books", "Timelines"))

# audio resources
app.add_media_files('/bhs5_audio', os.path.join(BIBLEMATEWEB_DATA, "audio", "bibles", "BHS5", "default"))
app.add_media_files('/ognt_audio', os.path.join(BIBLEMATEWEB_DATA, "audio", "bibles", "OGNT", "default"))
audio_dir = os.path.join(BIBLEMATEWEB_DATA, "audio", "bibles")
if os.path.isdir(audio_dir):
    ...
    config.audio = {}
audio_dir_custom = os.path.join(BIBLEMATEWEB_DATA_CUSTOM, "audio", "bibles")
