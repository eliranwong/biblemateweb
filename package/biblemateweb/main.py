        ...
        with ui.expansion('AI Backend', icon='memory').classes('w-full rounded-lg'):
            with ui.column().classes('w-full p-4 gap-4'):
                ui.select(label='AI Backend',
                          options=['default', 'googleai', 'openai', 'anthropic', 'cohere', 'deepseek', 'mistral', 'xai', 'azure_anthropic', 'azure_cohere', 'azure_deepseek', 'azure_mistral', 'azure_openai', 'azure_xai', 'custom']) \
