...
def create_parousia_page_en():
    ...
    with ui.column().classes('w-full max-w-4xl mx-auto p-4 gap-6'):
        ...
        # =================================================
        ui.label('Key Scriptural Framework: 1 Cor 15:23–27, Pauline Epistles, Rev 20').classes('text-gray-500 mt-4 text-sm')
        ...
        with ui.timeline(side='right').classes('w-full'):
            ...
            with ui.timeline_entry(
                title='Context: Post-tribulation',
                ...
                with ui.card().classes('bg-red-50 w-full mt-2 border-l-4 border-red-500'):
                    ...
                    render_verse_chips([
                        ...
                        '2 Thess 2:1', '2 Thess 2:3', '1 John 4:3', 
                        '2 John 1:7', 'Rev 13–17', 'Rev 6–17', 
                        'Rev 7:1–8, 9, 14'
                    ])
            ...
            with ui.timeline_entry(
                ...
                with ui.card().classes('bg-blue-50 w-full mt-2 border-l-4 border-blue-500'):
                    ...
                    ui.markdown('**ii. Resurrection of Dead and Living Believers**')
                    render_verse_chips([
...
def main_page_en():
    ...
    create_parousia_page_en()

ui.run(title='Biblemate Parousia Sequence (EN)', port=9999)